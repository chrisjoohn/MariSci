...
public class Database {
    ...
    public ArrayList<String> getTeacher(String username, String password) throws Exception{
    ...
    public boolean addStudentToDB(String firstName,
        ...
        try{
            ...
            prepSt.setString(7, username);
            prepSt.setString(8, email);
            prepSt.setString(9, password);
...
//    }
    ...
    public boolean setLRNAttendance(){
        String query="INSERT INTO attendance(LRN) SELECT LRN FROM students";
        String query1 = "UPDATE attendance SET date=? WHERE date=0000-00-00";
        try{
            PreparedStatement prepSt = conn.prepareStatement(query);
            PreparedStatement preparedStatement = conn.prepareStatement(query1);

            if(prepSt.execute() && preparedStatement.execute())
                return true;
...
//    }
    ...
    public boolean getAttendance(String LRN){
        ...
        String query = "SELECT * FROM attendance WHERE date = ? AND LRN = ?";
     ...
     */
    public ArrayList<ArrayList<String>> getAttendanceRecord(String date, String section, String gradeLevel){
        ...
        try{
            ...
            while(rs.next()){
                ...
                data.add(rs.getString("first_name"));
                data.add(rs.getString("last_name"));
                data.add(rs.getString("isPresent"));
                data.add(rs.getString("time_in"));
                data.add(rs.getString("time_out"));
